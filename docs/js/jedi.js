...
class EditorArrayNav extends _array_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    ...
    const nav = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaXOption)(schema, 'nav')
    return schemaType === 'array' && (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.isSet)(nav)
  }
...
class EditorBooleanCheckbox extends _boolean_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    const schemaType = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaType)(schema)
    const schemaFormat = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaFormat)(schema)
...
class EditorBooleanEnumSelect extends _boolean_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    ...
    const isBooleanWithoutFormat = schemaType === 'boolean' && (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.notSet)(schemaFormat)
...
class EditorNumberEnumRadio extends _number_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    ...
    return typeIsNumeric && (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.isSet)(schemaEnum) && schemaFormat === 'radio'
  }
...
class EditorNumberEnumSelect extends _number_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    ...
    const schemaEnum = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaEnum)(schema)
    const typeIsNumeric = schemaType === 'number' || schemaType === 'integer'
    return typeIsNumeric && (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.isSet)(schemaEnum)
  }
...
class EditorObjectNav extends _object_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    const schemaType = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaType)(schema)
    const nav = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaXOption)(schema, 'nav')
    return schemaType === 'object' && (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.isSet)(nav)
  }
...
class EditorStringAwesomplete extends _string_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    const schemaType = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaType)(schema)
    const awesomplete = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaXOption)(schema, 'awesomplete')
    return schemaType === 'string' && (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.isSet)(awesomplete)
  }
...
class EditorStringEnumSelect extends _string_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    const schemaType = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaType)(schema)
    const schemaEnum = (0,_helpers_schema_js__WEBPACK_IMPORTED_MODULE_2__.getSchemaEnum)(schema)
    return schemaType === 'string' && (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.isSet)(schemaEnum)
  }
...
class EditorStringInput extends _string_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static resolves (schema) {
    ...
    const isStringWithoutFormat = schemaType === 'string' && (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.notSet)(schemaFormat)
