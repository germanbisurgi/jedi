    ...
    Object.keys(value).forEach((key) => {
      ...
      if (child) {
        ...
        if (this.schema.patternProperties) {
          schema = (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.mergeDeep)({}, this.schema.patternProperties, (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_1__.clone)(schema))
        }
