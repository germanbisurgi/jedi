  ...
  if (utils_isObject(value) && isSet(schema.additionalProperties())) {
    ...
    if (properties) {
      Object.keys(value).forEach(function (property) {
        ...
        if (!inPatternProperty && utils_isObject(additionalProperties) && !hasOwn(properties, property)) {
          var editor = new src({
            rootName: property,
