...
var jedi_Jedi = /*#__PURE__*/function (_EventEmitter) {
  ...
  createClass_default()(Jedi, [{
    ...
    value: function init() {
      ...
      var dereferencedSchema = this.refParser.dereference(this.options.schema);
      this.schema = new src_schema(dereferencedSchema);
