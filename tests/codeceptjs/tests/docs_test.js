...
Scenario('should set value', async ({ I }) => {
  ...
  I.seeInField('[id="root.strings.string-textarea"]', 'test')
  I.seeInField('[id="root.strings.string-enum-select"]', 'carl')
  I.seeInField('[name="root.strings.string-enum-radio"]', 'carl')
  I.seeInField('[id="root.numbers.number"]', 69)
  I.seeInField('[id="root.numbers.number-enum-select"]', '3.5')
  I.seeInField('[name="root.numbers.number-enum-radio"]', '3.5')
  I.seeInField('[id="root.integers.integer"]', 69)
  I.seeInField('[id="root.integers.integer-enum-select"]', '3')
  I.seeInField('[name="root.integers.integer-enum-radio"]', '3')
})
