...
Scenario('Should @watch and @calc fields', ({I}) => {
  ...
  I.waitForValue('#root-test-summe', 1)
  I._fillField('#root-test-numbers-b', 1)
  I.waitForValue('#root-test-summe', 2)
  I._click('#root-test-condition-1')
  I.waitForValue('#root-test-summe', 0)
  I._click('#root-test-condition-0')
  I.waitForValue('#root-test-numbers-a', 0)
  I.waitForValue('#root-test-numbers-b', 0)
  I.waitForValue('#root-test-summe', 0)
  I._fillField('#root-test-numbers-a', 1)
  I.waitForValue('#root-test-summe', 1)
  I._fillField('#root-test-numbers-b', 1)
