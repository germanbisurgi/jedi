...
Scenario('Should @watch and @calc fields', ({I}) => {
  ...
  I._waitForValue('#root-c', 11)
  I._waitForValue('#root-sum', 16)

  I._fillField('#root-something-numbers-0', 3)
  I._waitForValue('#root-something-numbersTotal', 6)
  I._waitForValue('#root-sum', 17)

  I._click('.jedi-array-add')
  I._waitForElement('#root-something-numbers-2')
  I._fillField('#root-something-numbers-2', 1)
  I._waitForValue('#root-something-numbersTotal', 7)
  I._waitForValue('#root-sum', 18)
})
