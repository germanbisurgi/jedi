...
function R(i) {
  if (!(typeof i > "u"))
    return JSON.parse(JSON.stringify(i, Qe()));
}
function Ye(i) {
  return i.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
}
...
function et(i) {
  let e = "any";
  return j(i) ? e = B(i) ? "integer" : "number" : V(i) ? e = "string" : T(i) ? e = "boolean" : w(i) ? e = "array" : Le(i) ? e = "null" : f(i) && (e = "object"), e;
}
function D(i, ...e) {
  if (!e.length)
    return i;
...
class _t {
  constructor(e = {}) {
    this.refParser = e.refParser, this.validateFormat = e.validateFormat ? e.validateFormat : !1, this.draft = Xe, this.jsonSchemaDrafts = {
      ...
      "https://json-schema.org/draft/2020-12/schema": Xe
    };
  }
  /**
...
class Pt extends Re {
  static resolves(e) {
    return I(e) === "boolean" && m(e, "format") === "radio";
  }
  build() {
...
class Ot extends Re {
  static resolves(e) {
    return I(e) === "boolean" && m(e, "format") === "checkbox";
  }
  build() {
...
class Tt extends $ {
  static resolves(e) {
    return I(e) === "string" && m(e, "format") === "radio";
  }
  build() {
    this.control = this.theme.getRadiosControl({
...
class kt extends $ {
  static resolves(e) {
    return I(e) === "string" && m(e, "format") === "textarea";
  }
  build() {
    this.control = this.theme.getTextareaControl({
      ...
      label: A(this.instance.schema) || this.instance.getKey(),
      labelIconClass: m(this.instance.schema, "labelIconClass"),
      titleHidden: m(this.instance.schema, "titleHidden") || m(this.instance.schema, "format") === "hidden",
      description: k(this.instance.schema)
    });
  }
  addEventListeners() {
...
class Mt extends $ {
  static resolves(e) {
    return I(e) === "string" && d(m(e, "awesomplete"));
  }
  build() {
...
class Ve extends $ {
  ...
  build() {
    const e = m(this.instance.schema, "format");
    this.control = this.theme.getInputControl({
...
class Rt extends He {
  static resolves(e) {
    const t = I(e), s = M(e), r = m(e, "format");
  ...
  refreshPropertiesSlot() {
    ...
    if (Ce(this.instance.jedi.options.enablePropertiesToggle, !0) || Ce(e, !0)) {
      ...
      [...t, ...s].forEach((n) => {
        ...
        y && (y.disabled = this.disabled, y.checked = q(this.instance.getValue(), n));
      });
    }
  }
  refreshEditors() {
...
class us extends At {
  ...
  createInstance(e) {
    ...
    const s = I(e.schema), r = U(e.schema), n = N(e.schema), a = we(e.schema), o = Pe(e.schema), l = Ie(e.schema);
...
class qe {
  ...
  getRadiosControl(e) {
    ...
    return e.values.forEach((y, v) => {
      ...
      We.setAttribute("for", e.id + "-" + v);
      const _e = document.createElement("span");
      L.push(_e), e.titles && e.titles[v] && (_e.textContent = e.titles[v]), E.push(We);
