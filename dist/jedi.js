...
function k(i) {
  if (!(typeof i > "u"))
    return JSON.parse(JSON.stringify(i, te()));
}
function ee(i) {
  return i.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
}
function Dt(i, t, e) {
  return i.replace(new RegExp(ee(t), "g"), e);
}
function w(i) {
  return Dt(Dt(i, "#", "root"), "/", "-");
}
...
function wt(i, t) {
  return f(i) && f(t) && (i = It(i), t = It(t)), JSON.stringify(i) === JSON.stringify(t);
}
function Pt(i, t) {
  return !wt(i, t);
}
...
function se(i) {
  let t = "any";
  return O(i) ? t = H(i) ? "integer" : "number" : V(i) ? t = "string" : P(i) ? t = "boolean" : x(i) ? t = "array" : At(i) ? t = "null" : f(i) && (t = "object"), t;
}
function K(i, ...t) {
  if (!t.length)
    return i;
  const e = t.shift();
  return f(i) && f(e) && Object.keys(e).forEach((s) => {
    f(e[s]) ? (i[s] || Object.assign(i, {
      [s]: {}
...
function St(i) {
  return f(i.additionalProperties) || P(i.additionalProperties) ? i.additionalProperties : void 0;
}
function ae(i) {
  return f(i.propertyNames) || P(i.propertyNames) ? i.propertyNames : void 0;
}
function Kt(i) {
...
function ce(i) {
  return f(i.contains) || P(i.contains) ? i.contains : void 0;
}
function de(i) {
  return i.default;
}
...
function Ot(i) {
  return f(i.else) || P(i.else) ? i.else : void 0;
}
function T(i) {
...
function Jt(i) {
  return f(i.items) || P(i.items) ? i.items : void 0;
}
function pe(i) {
...
function Ee(i) {
  return f(i.not) || P(i.not) ? i.not : void 0;
}
function m(i, t) {
...
function Vt(i) {
  return f(i.then) || P(i.then) ? i.then : void 0;
}
function I(i) {
...
function J(i, t, e, s) {
  ...
  return l(r) && r.forEach((a) => {
    const o = new S({ refParser: i.refParser, schema: a, data: t, rootName: s }), c = o.getErrors();
    o.destroy(), n = [...n, ...c], n = $t(n);
  }), n;
}
const b = {
...
function _(i, t, e, s, n) {
  ...
  if (l(a)) {
    let o = !1;
    a.forEach((c) => {
      const d = new S({ refParser: i.refParser, schema: c, data: t }), h = d.getErrors();
...
function Y(i, t, e, s, n) {
  ...
  if (m(e, "validateFormat") && (o = e.options.validateFormat), l(a) && V(t) && o) {
    let c;
...
function st(i, t, e, s, n) {
  const r = [], a = ge(e);
  return f(t) && l(a) && Object.keys(t).length > a && r.push({
    messages: [
...
function ot(i, t, e, s, n) {
  const r = [], a = Ee(e);
  if (l(a)) {
    const o = new S({ refParser: i.refParser, schema: a, data: t }), c = o.getErrors();
...
function lt(i, t, e, s) {
  let n = [];
  const r = kt(e);
  return f(t) && l(r) && Object.keys(t).forEach((a) => {
...
function ft(i, t, e, s, n) {
  ...
  if (f(t) && l(a)) {
    ...
    d && Object.keys(t).forEach((p) => {
      let g = !1;
      if (l(u) && Object.keys(u).forEach((v) => {
        g = new RegExp(v).test(p);
      }), !g && h === !1 && !N(d, p) && r.push({
        messages: [
          y(b.errorAdditionalProperties, {
            property: p
          })
        ],
        path: n,
...
function yt(i, t, e) {
  let s = [];
  const n = le(e);
  return f(t) && l(n) && Object.keys(n).forEach((r) => {
    if (l(t[r])) {
      const a = n[r], o = new S({ refParser: i.refParser, schema: a, data: t }), c = o.getErrors();
      o.destroy(), s = [...s, ...c];
    }
  }), s;
}
function Lt(i, t, e) {
  ...
  if (l(n)) {
    if (U(r) && U(a))
      return s;
    const o = new S({ refParser: i.refParser, schema: n, data: t }), c = o.getErrors();
    o.destroy();
    let d = [], h = [];
    if (l(r)) {
      const u = new S({ refParser: i.refParser, schema: r, data: t });
      d = u.getErrors(), u.destroy();
    }
    if (l(a)) {
      const u = new S({ refParser: i.refParser, schema: a, data: t });
...
function Et(i, t, e, s, n) {
  ...
  return x(t) && l(a) && a.forEach((o, c) => {
    const d = t[c];
    if (l(d)) {
      const h = new S({ refParser: i.refParser, schema: o, data: d }), u = h.getErrors();
...
function Qt(i, t, e, s, n) {
  let r = [];
  const a = Ie(e), o = kt(e), c = Mt(e), d = Kt(e), h = $(e), u = z(e);
  if (f(t) && l(a)) {
    let p = l(c) ? c : {};
    const g = a, v = o;
    [
      ...
      let E = !1;
      if (l(v) && Object.keys(v).forEach((q) => {
...
const Oe = {
  ...
  required: ht,
  type: ut,
  unevaluatedProperties: Qt,
  uniqueItems: mt
};
function je(i, t, e, s, n) {
  const r = [], a = ae(e);
  return f(t) && l(a) && Object.keys(t).forEach((o) => {
    new S({
      refParser: i.refParser,
      schema: a,
      data: o
...
class xt {
  ...
  getObjectControl(t) {
    const e = document.createElement("div"), s = this.getActionsSlot(), n = this.getArrayActionsSlot(), r = this.getCardBody(), a = this.getPropertiesAriaLive(), o = this.getDescription({
      ...
      label: "Property"
    }), v = this.getAddPropertyButton(), L = this.getFieldset(), C = this.getLegend({
      textContent: t.title,
      id: t.id
    });
    return v.classList.add("jedi-object-add"), e.appendChild(L), L.appendChild(C), L.appendChild(r), r.appendChild(o), r.appendChild(c), C.appendChild(s), s.appendChild(n), r.appendChild(h), r.appendChild(d), t.addProperty && (h.appendChild(g.container), h.appendChild(v)), t.editableProperties && (s.appendChild(u), h.appendChild(a), h.appendChild(p)), {
      container: e,
      body: r,
      actions: s,
      messages: c,
  ...
  getRadiosControl(t) {
    ...
    return t.values.forEach((C, E) => {
      ...
      L.push(Nt), t.titles && t.titles[E] && (Nt.textContent = t.titles[E]), v.push(gt);
    }), e.appendChild(r), e.appendChild(s), r.appendChild(o), r.appendChild(a), s.appendChild(n), p.forEach((C, E) => {
      a.appendChild(p[E]), C.appendChild(g[E]), C.appendChild(v[E]), v[E].appendChild(L[E]);
    }), r.appendChild(u), r.appendChild(d), { container: e, fieldset: r, legend: o, body: a, radios: g, labels: v, labelTexts: L, radioControls: p, description: u, messages: d, actions: s, arrayActions: n };
  }
  /**
   * A checkbox control
   * @private
  ...
  getSelectControl(t) {
    ...
    r.setAttribute("id", t.id), r.style.width = "100%", t.values.forEach((g, v) => {
      const L = document.createElement("option");
      L.setAttribute("value", g), t.titles && t.titles[v] && (L.textContent = t.titles[v]), r.appendChild(L);
    });
    const a = document.createElement("label");
    a.setAttribute("for", t.id);
    const o = document.createElement("span");
...
class F {
  constructor(t) {
    if (this.instance = t, this.theme = null, this.control = null, this.disabled = !1, this.readOnly = this.instance.isReadOnly(), this.init(), this.build(), this.coerceValue(), this.addEventListeners(), this.setContainerAttributes(), this.refreshUI(), this.instance.jedi.options.showErrors === "always" || m(this.instance.schema, "showErrors") === "always") {
  ...
  prepare() {
    ...
    this.schemas.forEach((r) => {
      ...
      this.instances.forEach((c) => {
        const d = c.getValue();
        let h = r;
        f(d) && f(h) && (h = ie(d, h)), c.setValue(h, !1);
      });
...
class Ue extends D {
  ...
  prepare() {
    ...
    if (l($(this.schema)) || l(z(this.schema))) {
      ...
      delete n.anyOf, delete n.oneOf, delete n.options, s.forEach((r, a) => {
        ...
        let o = "Option-" + (a + 1);
        const c = m(r, "switcherTitle"), d = I(r);
  ...
  onSetValue() {
    if (Pt(this.activeInstance.getValue(), this.value)) {
...
class Ht extends F {
  ...
  refreshPropertiesSlot() {
    const t = m(this.instance.schema, "editableProperties");
    (wt(this.instance.jedi.options.editableProperties, !0) || wt(t, !0)) && Object.keys(this.instance.properties).forEach((e) => {
      const s = this.instance.isRequired(e), n = this.instance.isDependentRequired(e), r = !s && !n, a = this.propertyActivators[e], o = this.control.ariaLive, c = this.instance.properties[e].schema, d = I(c), h = this.instance.path + this.instance.jedi.pathSeparator + e, u = w(h) + "-activator", p = l(d) ? d : e;
      if (r && !a) {
...
class Je extends Ht {
  refreshEditors() {
    ...
    this.control.childrenSlot.appendChild(t), this.instance.children.forEach((e) => {
      if (e.isActive) {
        const s = m(e.schema, "columns") || 12, n = m(e.schema, "offset") || 0, r = this.theme.getCol(12, s, n);
        m(e.schema, "newRow") === !0 && (t = this.theme.getRow(), this.control.childrenSlot.appendChild(t)), t.appendChild(r), r.appendChild(e.ui.control.container), this.disabled || this.instance.isReadOnly() ? e.ui.disable() : e.ui.enable();
      }
    });
  }
}
class Ge extends Ht {
  ...
  refreshEditors() {
    ...
    this.control.childrenSlot.appendChild(n), n.appendChild(a), n.appendChild(o), a.appendChild(d), o.appendChild(c), this.instance.children.forEach((h, u) => {
      if (h.isActive) {
        const p = u === this.activeTabIndex, g = w(h.path), v = I(h.schema), L = this.theme.getTab({
          title: l(v) ? v : h.getKey(),
          id: g,
          active: p
        });
...
class _e extends D {
  ...
  prepare() {
    ...
    l(t) && Object.keys(t).forEach((e) => {
      ...
      let n = !0;
      const r = m(this.schema, "deactivateNonRequired"), a = m(s, "deactivateNonRequired");
  ...
  createChild(t, e, s) {
    ...
    const r = m(this.schema, "deactivateNonRequired");
...
class Zt extends F {
  ...
  refreshUI() {
    this.refreshInteractiveElements();
    const t = Gt(this.instance.schema), e = _t(this.instance.schema);
...
class We extends Zt {
  ...
  refreshUI() {
    ...
    const t = m(this.instance.schema, "navCols"), e = m(this.instance.schema, "navStacked"), s = m(this.instance.schema, "navType"), n = this.theme.getRow(), r = l(t) ? t : 3, a = this.theme.getCol(12, r), o = this.theme.getCol(12, 12 - r), c = this.theme.getTabContent(), d = this.theme.getTabList({
      stacked: l(e) ? e : !1,
      type: l(s) ? s : "pils"
    });
    this.control.childrenSlot.appendChild(n), n.appendChild(a), n.appendChild(o), a.appendChild(d), o.appendChild(c), this.instance.children.forEach((h, u) => {
      const p = this.theme.getDeleteItemBtn(), g = this.theme.getMoveUpItemBtn(), v = this.theme.getMoveDownItemBtn();
      h.ui.control.arrayActions.innerHTML = "", h.ui.control.arrayActions.appendChild(p), h.ui.control.arrayActions.appendChild(g), h.ui.control.arrayActions.appendChild(v), this.control.childrenSlot.appendChild(h.ui.control.container);
      let L;
      const C = m(this.instance.schema, "itemTemplate");
      if (C) {
        const A = C, gt = {
          i0: u,
          i1: u + 1,
      ...
      const E = u === this.activeTabIndex, q = w(h.path), M = this.theme.getTab({
        title: L,
        id: q,
        active: E
      });
      M.list.addEventListener("click", () => {
        this.activeTabIndex = u;
      }), this.theme.setTabPaneAttributes(h.ui.control.container, E, q), d.appendChild(M.list), c.appendChild(h.ui.control.container), this.disabled || this.instance.isReadOnly() ? h.ui.disable() : h.ui.enable(), u === 0 && g.setAttribute("disabled", ""), this.instance.value.length - 1 === u && v.setAttribute("disabled", "");
    });
  }
}
class Qe extends D {
  setUI() {
    const t = R(this.schema), e = B(this.schema);
    t === "array" && e === "nav" ? this.ui = new We(this) : this.ui = new Zt(this);
  }
  prepare() {
  ...
  createItemInstance(t) {
    let e;
    const s = this.children.length, n = Jt(this.schema), r = Tt(this.schema);
...
class Xe extends Bt {
  build() {
    this.control = this.theme.getRadiosControl({
      ...
      titles: m(this.instance.schema, "enumTitles") || T(this.instance.schema),
      id: w(this.instance.path),
      label: I(this.instance.schema) || this.instance.getKey(),
      titleHidden: m(this.instance.schema, "titleHidden"),
      description: j(this.instance.schema)
...
class Ze extends F {
  build() {
    this.control = this.theme.getTextareaControl({
      id: w(this.instance.path),
      label: I(this.instance.schema) || this.instance.getKey(),
      titleHidden: m(this.instance.schema, "titleHidden") || B(this.instance.schema) === "hidden",
      description: j(this.instance.schema)
    });
  }
  addEventListeners() {
