...
function z(i, e) {
  return f(i) && f(e) && (i = Ee(i), e = Ee(e)), JSON.stringify(i) === JSON.stringify(e);
}
function $(i, e) {
  return !z(i, e);
}
...
function f(i) {
  return !Ie(i) && !S(i) && typeof i == "object";
}
function st(i) {
  let e = "any";
  return k(i) ? e = B(i) ? "integer" : "number" : V(i) ? e = "string" : T(i) ? e = "boolean" : S(i) ? e = "array" : Ie(i) ? e = "null" : f(i) && (e = "object"), e;
}
function U(i, ...e) {
  if (!e.length)
    return i;
...
const Ft = {
  ...
  getType: st,
  mergeDeep: U,
  overwriteExistingProperties: it,
  getValueByJSONPath: nt,
  compileTemplate: y,
  clamp: rt,
  removeDuplicatesFromArray: De
};
function Kt(i, e) {
  const t = "x-" + e;
  return i[t];
...
function we(i) {
  return S(i.allOf) ? i.allOf : void 0;
}
function D(i) {
  return S(i.anyOf) ? i.anyOf : void 0;
}
function Ue(i) {
  return i.const;
}
...
function Ae(i) {
  return S(i.prefixItems) ? i.prefixItems : void 0;
}
function G(i) {
...
function Ge(i) {
  return S(i.required) ? [...new Set(i.required)] : void 0;
}
function Ze(i) {
...
function C(i) {
  if (V(i.type) || S(i.type))
    return i.type;
}
function J(i) {
  return S(i.oneOf) ? i.oneOf : void 0;
}
function It(i) {
...
const $t = {
  getSchemaX: Kt,
  getSchemaSchema: Jt,
  getSchemaAdditionalProperties: xe,
  getSchemaPropertyNames: at,
  getSchemaAllOf: we,
  getSchemaAnyOf: D,
  getSchemaConst: Ue,
  getSchemaContains: ot,
  getSchemaDefault: qe,
  getSchemaDependentRequired: Fe,
  getSchemaDependentSchemas: lt,
  getSchemaDescription: P,
  getSchemaElse: Ke,
  getSchemaEnum: M,
  ...
  getSchemaXOption: p,
  getSchemaPattern: Et,
  getSchemaPatternProperties: Q,
  getSchemaPrefixItems: Ae,
  getSchemaProperties: G,
  getSchemaReadOnly: Ne,
  getSchemaRequired: Ge,
  getSchemaThen: Ze,
  getSchemaTitle: w,
  getSchemaType: C,
  getSchemaOneOf: J,
  getSchemaUnevaluatedProperties: It,
  getSchemaUniqueItems: xt
};
function W(i, e, t, s) {
  let r = [];
  const n = we(t);
...
function ne(i, e, t, s, r) {
  const n = [], a = $e(t);
  return S(e) && d(a) && e.length > a && n.push({
    messages: [
      y(b.errorMaxItems, {
        maxItems: a
      })
...
function ge(i, e, t, s, r) {
  ...
  if (d(a)) {
    ...
    let l = !0;
    S(a) ? l = a.some((c) => o[c](e)) : l = o[a](e), l || n.push({
      messages: [
        y(b.errorType, {
          type: a,
          valueType: st(e)
...
function Ce(i, e, t, s, r) {
  const n = [], a = xe(t), o = Q(t), l = G(t);
  if (f(e) && d(a)) {
    const c = l || {}, h = a, u = o || {};
    Object.keys(e).forEach((m) => {
      const g = Object.keys(u).some((E) => new RegExp(E).test(m)), I = q(c, m);
      if (!g && !I) {
        if (h === !1)
          n.push({
            messages: [
              y(b.errorAdditionalProperties, { property: m })
            ],
            path: r,
...
function ke(i, e, t, s, r) {
  const n = [], a = Ae(t);
  return S(e) && d(a) && a.forEach((o, l) => {
    const c = e[l];
    if (d(c)) {
...
function wt(i, e, t, s, r) {
  let n = [];
  const a = It(t), o = Q(t), l = G(t), c = we(t), h = D(t), u = J(t);
  if (f(e) && d(a)) {
    let m = d(l) ? l : {};
    const g = a, I = o;
    [
      ...
      let v = !1;
      if (d(I) && Object.keys(I).forEach((x) => {
        v = new RegExp(x).test(L);
      }), !v && g === !1 && !q(m, L) && n.push({
        messages: [
        ...
        const x = new j({
          ...
          schema: g,
          data: e[L]
        }), O = x.getErrors().map((Le) => ({
          messages: Le.messages,
          path: L,
          constrain: "unevaluatedProperties"
        }));
        n = [...n, ...O], x.destroy();
...
class _t {
  constructor(e = {}) {
    this.refParser = e.refParser, this.validateFormat = e.validateFormat ? e.validateFormat : !1, this.draft = Ye, this.jsonSchemaDrafts = {
      "http://json-schema.org/draft-04/schema#": zt,
      "http://json-schema.org/draft-06/schema#": Gt,
      "http://json-schema.org/draft-07/schema#": Zt,
      "https://json-schema.org/draft/2019-09/schema": Qt,
      "https://json-schema.org/draft/2020-12/schema": Ye
    };
  }
  /**
...
class F extends At {
  ...
  register() {
    ...
    const e = (t) => {
      this.jedi.register(t), t.children.forEach(e);
    };
   ...
   */
  setValue(e, t = !0) {
    const s = qe(this.schema);
    if (this.isReadOnly() && d(s) && $(e, s))
      return;
    const r = this.jedi.options.enforceConst || p(this.schema, "enforceConst");
    if (d(r) && z(r, !0)) {
      const n = Ue(this.schema);
      if (d(n) && $(e, n))
        return;
    }
  ...
  isReadOnly() {
    let e = !1;
    return Ne(this.schema) === !0 && (e = !0), this.parent && Ne(this.parent.schema) === !0 && (e = !0), e;
  }
  /**
   * Destroy the instance and it's children
   */
  destroy() {
    this.unregister(), this.listeners = [], this.children.forEach((e) => {
      e.destroy();
    }), this.ui && this.ui.destroy(), Object.keys(this).forEach((e) => {
      delete this[e];
    }), super.destroy();
  }
}
class K {
  ...
  setContainerAttributes() {
    this.control.container.setAttribute("data-path", this.instance.path), this.control.container.setAttribute("data-type", C(this.instance.schema));
  }
  /**
...
class Qe extends K {
  ...
  build() {
    this.control = this.theme.getIfThenElseControl({
      ...
      description: P(this.instance.schema),
...
class Xt extends F {
  ...
  prepare() {
    this.instances = [], this.activeInstance = null, this.index = 0, this.schemas = [], this.switcherOptionValues = [], this.switcherOptionsLabels = [], this.ifThenElseShemas = [], this.traverseSchema(this.schema), delete this.schema.if, delete this.schema.then, delete this.schema.else;
    let e = 0;
    this.ifThenElseShemas.forEach((n) => {
      d(n.then) && (this.schemas.push(U({}, R(this.schema), n.then)), this.switcherOptionValues.push(e), this.switcherOptionsLabels.push("then"), e++), d(n.else) && (this.schemas.push(U({}, R(this.schema), n.else)), this.switcherOptionValues.push(e), this.switcherOptionsLabels.push("else"), e++);
    });
    ...
    this.schemas.forEach((n) => {
      ...
      this.instances.forEach((l) => {
        const c = l.getValue();
        let h = n;
        f(c) && f(h) && (h = it(c, h)), l.setValue(h, !1);
      });
      const a = this.getFittestIndex(n);
      a !== this.index && this.switchInstance(a);
    }), this.value = s.getValue(), s.destroy();
    const r = this.getFittestIndex(this.value);
    this.switchInstance(r);
  }
  switchInstance(e) {
    this.activeInstance && this.activeInstance.unregister(), this.index = e, this.activeInstance = this.instances[this.index], this.activeInstance.register(), this.value = this.activeInstance.getValue();
  }
  traverseSchema(e) {
    const t = Z(e);
    if (d(t)) {
...
class Yt extends F {
  prepare() {
    ...
    const e = C(this.schema);
    if (d(D(this.schema)) || d(J(this.schema))) {
      const s = d(D(this.schema)) ? D(this.schema) : J(this.schema), r = R(this.schema);
  ...
  onSetValue() {
    if ($(this.activeInstance.getValue(), this.value)) {
...
class ts extends F {
  ...
  getPropertySchema(e) {
    let t;
    const s = xe(this.schema), r = G(this.schema), n = Q(this.schema);
    return d(r) && q(r, e) ? t = r[e] : d(n) && Object.keys(n).forEach((a) => {
...
class ss extends F {
  ...
  createItemInstance(e) {
    let t;
    const s = this.children.length, r = Je(this.schema), n = Ae(this.schema);
...
class St extends Me {
  static resolves(e) {
    return C(e) === "boolean" && p(e, "format") === "radio";
  }
  build() {
...
class Ot extends Me {
  static resolves(e) {
    return C(e) === "boolean" && p(e, "format") === "checkbox";
  }
  build() {
...
class jt extends N {
  static resolves(e) {
    return C(e) === "string" && p(e, "format") === "radio";
  }
  build() {
    this.control = this.theme.getRadiosControl({
...
class kt extends N {
  static resolves(e) {
    return C(e) === "string" && p(e, "format") === "textarea";
  }
  build() {
...
class Mt extends N {
  static resolves(e) {
    return window.Awesomplete && C(e) === "string" && d(p(e, "awesomplete"));
  }
  build() {
...
class ye extends K {
  sanitize(e) {
    return C(this.instance.schema) === "integer" ? Math.floor(Number(e)) : Number(e);
  }
}
class Rt extends ye {
  static resolves(e) {
    const t = C(e), s = M(e), r = p(e, "format");
...
class Ve extends K {
  ...
  build() {
    ...
    let t = !0;
    const s = xe(this.instance.schema);
    d(s) && s === !1 && (t = !1);
    let r = !1;
  ...
  refreshPropertiesSlot() {
    ...
    if (z(this.instance.jedi.options.enablePropertiesToggle, !0) || z(e, !0)) {
      const t = Object.keys(this.instance.properties), s = this.instance.children.map((n) => n.getKey());
      [...t, ...s].forEach((n) => {
        const a = this.instance.isRequired(n), o = this.instance.isDependentRequired(n), l = !a && !o, c = this.propertyActivators[n], h = this.control.ariaLive, u = this.instance.getPropertySchema(n), m = w(u), g = this.instance.path + this.instance.jedi.pathSeparator + n, I = A(g) + "-activator", E = d(m) ? m : n;
        if (l && !c) {
          ...
          this.propertyActivators[n] = x, x.addEventListener("change", () => {
            h.innerHTML = "";
            const O = this.theme.getAriaLiveMessage();
            x.checked ? (this.instance.getChild(n) || this.instance.createChild(u, n), this.instance.getChild(n).activate(), O.textContent = E + " field was added to the form", h.appendChild(O)) : (this.instance.getChild(n).deactivate(), O.textContent = E + " field was removed from the form", h.appendChild(O)), this.control.propertiesContainer.close(), this.control.propertiesContainer.showModal();
          }), this.control.propertiesActivators.appendChild(v.container);
        }
        const L = this.propertyActivators[n];
        L && (L.disabled = this.disabled, L.checked = q(this.instance.getValue(), n));
      });
    }
  }
  refreshEditors() {
...
class Bt extends Ve {
  ...
  refreshEditors() {
    ...
    this.control.childrenSlot.appendChild(e), this.instance.children.forEach((t) => {
      if (t.isActive) {
        const s = p(t.schema, "grid"), r = (s == null ? void 0 : s.columns) || 12, n = (s == null ? void 0 : s.offset) || 0, a = this.theme.getCol(12, r, n);
        ((s == null ? void 0 : s.newRow) || !1) && (e = this.theme.getRow(), this.control.childrenSlot.appendChild(e)), e.appendChild(a), a.appendChild(t.ui.control.container), this.disabled || this.instance.isReadOnly() ? t.ui.disable() : t.ui.enable();
      }
    });
  }
}
class qt extends Ve {
  ...
  refreshEditors() {
    ...
    this.control.childrenSlot.appendChild(t), t.appendChild(r), t.appendChild(n), r.appendChild(o), n.appendChild(a), this.instance.children.forEach((l, c) => {
      if (l.isActive) {
        const h = c === this.activeTabIndex, u = A(l.path), m = w(l.schema), g = this.theme.getTab({
...
class We extends K {
  ...
  isSortable() {
    return window.Sortable && d(p(this.instance.schema, "sortable"));
  }
  refreshUI() {
    const e = $e(this.instance.schema), t = ze(this.instance.schema);
    this.control.childrenSlot.innerHTML = "", this.instance.children.forEach((s) => {
      const r = Number(s.getKey()), n = this.theme.getDeleteItemBtn(), a = this.theme.getMoveUpItemBtn(), o = this.theme.getMoveDownItemBtn(), l = this.theme.getBtnGroup(), { container: c, arrayActions: h, body: u } = this.theme.getArrayItem();
      if (h.appendChild(l), l.appendChild(n), l.appendChild(a), l.appendChild(o), this.isSortable()) {
        const m = this.theme.getDragItemBtn();
        l.appendChild(m);
      }
      this.control.childrenSlot.appendChild(c), u.appendChild(s.ui.control.container), n.addEventListener("click", () => {
        const m = Number(s.path.split(this.instance.jedi.pathSeparator).pop());
        this.instance.deleteItem(m);
      }), a.addEventListener("click", () => {
        const m = r - 1;
        this.instance.move(r, m);
    ...
    }), this.refreshInteractiveElements(), this.isSortable() && (this.sortable && this.sortable.destroy(), this.sortable = window.Sortable.create(this.control.childrenSlot, {
      animation: 150,
      handle: ".jedi-array-drag",
      disabled: this.disabled || this.readOnly,
      onEnd: (s) => {
        this.instance.move(s.oldIndex, s.newIndex);
      }
    })), d(e) && e === this.instance.value.length && this.control.addBtn.setAttribute("disabled", "");
  }
}
class Nt extends We {
  static resolves(e) {
    return C(e) === "array" && d(p(e, "nav"));
  }
  init() {
    super.init(), this.activeTabIndex = 0;
  }
  ...
  refreshUI() {
    ...
    this.control.childrenSlot.appendChild(t), t.appendChild(r), t.appendChild(n), r.appendChild(o), n.appendChild(a), this.instance.children.forEach((l, c) => {
      ...
      let g;
      const I = p(this.instance.schema, "itemTemplate");
      if (I) {
        const x = I, O = {
          i0: c,
          i1: c + 1,
      ...
      const E = c === this.activeTabIndex, L = A(l.path), v = this.theme.getTab({
        title: g,
        id: L,
        active: E
      });
...
class Dt extends K {
  static resolves(e) {
    const t = C(e), s = J(e), r = D(e);
    return d(r) || d(s) || t === "any" || S(t) || H(t);
  }
  build() {
...
class us extends N {
  static resolves(e) {
    return window.Quill && C(e) === "string" && d(p(e, "quill"));
  }
  build() {
...
class ps extends N {
  static resolves(e) {
    return window.Jodit && C(e) === "string" && d(p(e, "jodit"));
  }
  build() {
    this.control = this.theme.getTextareaControl({
      id: A(this.instance.path),
...
class ms extends N {
  static resolves(e) {
    return window.flatpickr && C(e) === "string" && d(p(e, "flatpickr"));
  }
  build() {
    this.control = this.theme.getInputControl({
      type: "text",
...
class fs extends ye {
  static resolves(e) {
    return typeof Raty < "u" && C(e) === "number" && d(p(e, "raty"));
  }
  build() {
    this.control = this.theme.getPlaceholderControl({
      id: A(this.instance.path),
    ...
    try {
      this.raty = new Raty(this.control.placeholder, Object.assign({}, p(this.instance.schema, "raty"), {
        click: (e) => {
          this.instance.setValue(e);
        }
      })), this.raty.init();
...
class bs extends At {
  ...
  init() {
    ...
    this.schema = this.options.schema, this.validator = new _t({ refParser: this.refParser, validateFormat: this.options.validateFormat }), this.root = this.createInstance({
      jedi: this,
  ...
  appendHiddenInput() {
    ...
    this.hiddenInput = e.input, this.hiddenInput.setAttribute("name", "json"), this.hiddenInput.removeAttribute("aria-describedby"), this.options.hiddenInputAttributes && f(this.options.hiddenInputAttributes) && Object.keys(this.options.hiddenInputAttributes).forEach((t) => {
      this.hiddenInput.setAttribute(t, this.options.hiddenInputAttributes[t]);
  ...
  createInstance(e) {
    if (this.options.mergeAllOf || p(e.schema, "mergeAllOf")) {
      const o = we(e.schema);
      d(o) && o.forEach((l) => {
        e.schema = U({}, e.schema, l);
      });
    }
    this.refParser && (e.schema = this.refParser.expand(e.schema, e.path));
    const s = C(e.schema), r = J(e.schema), n = D(e.schema), a = Z(e.schema);
    if (d(n) || d(r) || s === "any" || S(s) || H(s))
      return new Yt(e);
    if (d(a))
      return new Xt(e);
    if (s === "object")
...
class He {
  ...
  getDragItemBtn() {
    ...
    return e.classList.add("jedi-array-drag"), e;
  }
  /**
  ...
  getObjectControl(e) {
    const t = document.createElement("div"), s = this.getActionsSlot(), r = this.getArrayActionsSlot(), n = this.getCardBody(), a = this.getPropertiesAriaLive(), o = this.getDescription({
      ...
      label: "Property"
    }), v = this.getAddPropertyButton(), x = this.getFieldset(), O = this.getLegend({
      textContent: e.title,
      id: e.id
    });
    return v.classList.add("jedi-object-add"), t.appendChild(x), t.appendChild(h), x.appendChild(O), x.appendChild(g), g.appendChild(n), n.appendChild(o), n.appendChild(l), O.appendChild(s), s.appendChild(r), n.appendChild(c), e.addProperty && (h.appendChild(L.container), h.appendChild(v), h.appendChild(document.createElement("hr"))), e.enablePropertiesToggle && (s.appendChild(u), h.appendChild(a), h.appendChild(E)), e.enableCollapseToggle && s.appendChild(I), {
      container: t,
      collapse: g,
      collapseToggle: I,
      body: n,
  ...
  getArrayControl(e) {
    const t = document.createElement("div"), s = this.getActionsSlot(), r = this.getArrayActionsSlot(), n = this.getCardBody(), a = this.getDescription({
      ...
      textContent: e.title,
      id: e.id
    }), g = "collapse-" + e.id, I = this.getCollapse({
      id: g,
      startCollapsed: e.startCollapsed
    ...
    return t.appendChild(u), u.appendChild(m), u.appendChild(I), I.appendChild(n), n.appendChild(a), n.appendChild(o), m.appendChild(s), s.appendChild(c), c.appendChild(h), s.appendChild(r), n.appendChild(l), e.enableCollapseToggle && s.appendChild(E), {
      container: t,
      collapseToggle: E,
      collapse: I,
      body: n,
  ...
  getArrayItem() {
    const e = document.createElement("div"), t = this.getCard(), s = this.getActionsSlot(), r = this.getArrayActionsSlot(), n = this.getCardHeader(), a = this.getCardBody();
    return e.appendChild(t), t.appendChild(n), t.appendChild(a), n.appendChild(s), s.appendChild(r), {
      container: e,
      card: t,
      header: n,
      body: a,
  ...
  getMultipleControl(e) {
    ...
    return u.container.classList.add("jedi-switcher"), t.appendChild(l), t.appendChild(s), s.appendChild(a), s.appendChild(o), a.appendChild(r), e.switcher && r.appendChild(u.container), r.appendChild(n), o.appendChild(c), o.appendChild(h), {
      container: t,
      card: s,
      header: a,
      body: o,
  ...
  getIfThenElseControl(e) {
    ...
    return u.container.classList.add("jedi-switcher"), e.switcher && t.appendChild(u.container), t.appendChild(l), t.appendChild(c), t.appendChild(h), {
      container: t,
      card: s,
      header: a,
      body: o,
  ...
  getNullControl(e) {
    const t = document.createElement("div"), s = this.getActionsSlot(), r = this.getArrayActionsSlot(), { label: n, labelText: a } = this.getLabel({
      ...
      textContent: e.description,
      id: o
    }), c = this.getMessagesSlot(), h = document.createElement("br");
    return t.appendChild(n), t.appendChild(h), t.appendChild(l), t.appendChild(c), t.appendChild(s), s.appendChild(r), { container: t, label: n, labelText: a, description: l, messages: c, actions: s, arrayActions: r };
  }
  /**
   * A Textarea
   * @private
  ...
  getRadiosControl(e) {
    ...
    return e.values.forEach((L, v) => {
      ...
      const Le = l + " " + h;
      O.setAttribute("aria-describedby", Le);
      const _e = document.createElement("label");
      _e.setAttribute("for", e.id + "-" + v);
      const Xe = document.createElement("span");
      E.push(Xe), e.titles && e.titles[v] && (Xe.textContent = e.titles[v]), I.push(_e);
    }), t.appendChild(n), t.appendChild(s), n.appendChild(o), n.appendChild(a), s.appendChild(r), m.forEach((L, v) => {
      a.appendChild(m[v]), L.appendChild(g[v]), L.appendChild(I[v]), I[v].appendChild(E[v]);
  ...
  getSelectControl(e) {
    ...
    n.setAttribute("id", e.id), e.values.forEach((g, I) => {
      const E = document.createElement("option");
      E.setAttribute("value", g), e.titles && e.titles[I] && (E.textContent = e.titles[I]), n.appendChild(E);
    });
    const { label: a, labelText: o } = this.getLabel({
      for: e.id,
      text: e.label,
...
const Es = {
  ...
  Utils: Ft,
  EditorBoolean: Me,
  EditorBooleanEnumRadio: St,
  EditorBooleanEnumSelect: Pt,
